prompt --application/shared_components/user_interface/templates/report/responsive
begin
--   Manifest
--     ROW TEMPLATE: RESPONSIVE
--   Manifest End
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(41042067740577631109)
,p_row_template_name=>'Responsive'
,p_internal_name=>'RESPONSIVE'
