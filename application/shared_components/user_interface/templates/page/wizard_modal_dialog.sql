...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14551628527190634412)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878748909591543764)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878749483239543764)
,p_page_template_id=>wwv_flow_imp.id(14551628527190634412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878749971906543764)
,p_page_template_id=>wwv_flow_imp.id(14551628527190634412)
