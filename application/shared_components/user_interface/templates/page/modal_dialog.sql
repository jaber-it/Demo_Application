...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14551621720665634409)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878725391663543751)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878725829532543752)
,p_page_template_id=>wwv_flow_imp.id(14551621720665634409)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878726314177543752)
,p_page_template_id=>wwv_flow_imp.id(14551621720665634409)
