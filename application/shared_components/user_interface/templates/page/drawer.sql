...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(9705768079111325595)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878669646705543714)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878670160222543714)
,p_page_template_id=>wwv_flow_imp.id(9705768079111325595)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878670606313543714)
,p_page_template_id=>wwv_flow_imp.id(9705768079111325595)
