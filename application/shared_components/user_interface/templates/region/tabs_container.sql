...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14551671528873634430)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878933302983543872)
,p_plug_template_id=>wwv_flow_imp.id(14551671528873634430)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878933813011543872)
,p_plug_template_id=>wwv_flow_imp.id(14551671528873634430)
,p_name=>'Tabs'
