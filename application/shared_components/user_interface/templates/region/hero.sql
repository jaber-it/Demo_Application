...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14551654974541634423)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878849157583543825)
,p_plug_template_id=>wwv_flow_imp.id(14551654974541634423)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878849626444543826)
,p_plug_template_id=>wwv_flow_imp.id(14551654974541634423)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878850196097543826)
,p_plug_template_id=>wwv_flow_imp.id(14551654974541634423)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878850692621543826)
,p_plug_template_id=>wwv_flow_imp.id(14551654974541634423)
,p_name=>'Sub Regions'
