...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(35878957364026543886)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878957881396543887)
,p_plug_template_id=>wwv_flow_imp.id(35878957364026543886)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878958332634543887)
,p_plug_template_id=>wwv_flow_imp.id(35878957364026543886)
,p_name=>'Sub Regions'
