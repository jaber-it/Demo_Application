...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14551663479857634427)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878900178268543853)
,p_plug_template_id=>wwv_flow_imp.id(14551663479857634427)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878900672180543853)
,p_plug_template_id=>wwv_flow_imp.id(14551663479857634427)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878901191925543853)
,p_plug_template_id=>wwv_flow_imp.id(14551663479857634427)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878901648840543853)
,p_plug_template_id=>wwv_flow_imp.id(14551663479857634427)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35878902163681543854)
,p_plug_template_id=>wwv_flow_imp.id(14551663479857634427)
,p_name=>'Sub Regions'
