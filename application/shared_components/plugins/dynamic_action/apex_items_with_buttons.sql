...
begin
--   Manifest
--     PLUGIN: APEX.ITEMS.WITH.BUTTONS
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25986554783488369893)
...
,p_reference_id=>47798452710741910340
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25986554941999369897)
,p_plugin_id=>wwv_flow_imp.id(25986554783488369893)
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(25986556168759369906)
,p_plugin_id=>wwv_flow_imp.id(25986554783488369893)
,p_file_name=>'LICENSE'
